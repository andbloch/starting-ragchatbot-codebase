...
class TestVectorStore:
    ...
    def test_search_uses_default_max_results_when_no_limit_provided(
    ...
    def test_search_with_chromadb_exception(self, mock_vector_store):
        ...
        mock_vector_store.course_content.query.side_effect = Exception(
    ...
    def test_search_results_from_chroma_empty(self):
        ...
        empty_chroma_results = {"documents": [[]], "metadatas": [[]], "distances": [[]]}
