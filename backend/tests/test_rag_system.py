...
class TestRAGSystem:
    ...
    def test_query_basic_functionality(self, mock_rag_system):
        ...
        mock_rag_system.ai_generator.generate_response.return_value = "Python is a programming language"
    ...
    def test_query_with_session_id(self, mock_rag_system):
        ...
        mock_rag_system.session_manager.get_conversation_history.return_value = "Previous: Hello\nAI: Hi!"
        mock_rag_system.ai_generator.generate_response.return_value = "Response with context"
        mock_rag_system.tool_manager.get_last_sources.return_value = []
    ...
    def test_query_content_specific_questions(self, mock_rag_system):
        ...
        mock_rag_system.ai_generator.generate_response.return_value = "Detailed explanation about variables"
        mock_rag_system.tool_manager.get_last_sources.return_value = [
    ...
    def test_query_course_outline_questions(self, mock_rag_system):
        ...
        mock_rag_system.ai_generator.generate_response.return_value = "**Introduction to Python**\nLessons: 1. Basics, 2. Variables"
        mock_rag_system.tool_manager.get_last_sources.return_value = []
        
        response, sources = mock_rag_system.query("What lessons are in the Python course?")
    ...
    def test_add_course_document(self, mock_rag_system):
        ...
        mock_rag_system.document_processor.process_course_document.return_value = (test_course, test_chunks)
        ...
        mock_rag_system.vector_store.add_course_metadata.assert_called_once_with(test_course)
        mock_rag_system.vector_store.add_course_content.assert_called_once_with(test_chunks)
    ...
    def test_different_query_types(self, mock_rag_system):
        ...
        for query, query_type in test_cases:
            mock_rag_system.ai_generator.generate_response.return_value = f"Response to {query_type} question"
    ...
    def test_empty_sources_handling(self, mock_rag_system):
        ...
        mock_rag_system.ai_generator.generate_response.return_value = "No relevant content found"
        mock_rag_system.tool_manager.get_last_sources.return_value = []
    ...
    def test_multiple_source_types(self, mock_rag_system):
        ...
        mock_rag_system.ai_generator.generate_response.return_value = "Mixed sources response"
    ...
    def test_unexpected_error_handling(self, mock_rag_system):
        ...
        mock_rag_system.ai_generator.generate_response.side_effect = ValueError("Unexpected error")
    ...
    def test_error_handling_preserves_session_isolation(self, mock_rag_system):
        ...
        response, sources = mock_rag_system.query("Error query", session_id="test_session")
    ...
    def test_error_recovery_after_failure(self, mock_rag_system):
        ...
        mock_rag_system.ai_generator.generate_response.return_value = "Success after recovery"
        mock_rag_system.tool_manager.get_last_sources.return_value = [{"text": "Test source"}]
