...
class RAGSystem:
    ...
    def query(self, query: str, session_id: Optional[str] = None) -> Tuple[str, List[Union[str, Dict]]]:
        """
        ...
        Returns:
            Tuple of (response, sources list - can be strings or dicts with text/url)
        """
